<div class="edit-bar border">
  <div class="website-logo">
    ...
    <!-- <object class="svg-object disable-events" data="/assets/logo.svg" type="image/svg+xml"></object> -->
  </div>
  ...
  <ul class="register-icons-container">
    <ul class="edit-bar-icons-subcontainer border register-icons-container">
      ...
      <li class="list-element edit-bar-icon export dropdown">
        <object class="svg-object disable-events" data="/assets/edit_page_icons/export.svg" type="image/svg+xml" alt="Export"></object>
    ...
    <?php if (UserProfileService::getUserId()): ?>
    <?php view("profile_menu.view.php", ["userNotesList" => $userNotesList]) ?>
    <?php else: ?>
