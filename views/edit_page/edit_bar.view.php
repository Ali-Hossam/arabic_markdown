<div class="edit-bar border">
  ...
  <div class="edit-bar-icons-container">
    <ul class="edit-bar-icons-subcontainer no-border">
      ...
      <li class="list-element edit-bar-icon dropdown">
        <object class="svg-object" data="/assets/edit_page_icons/hash.svg" alt="Font size" type="image/svg+xml"></object>
        <span class="dropdown-icon">&#9660;</span>
    ...
    <ul class="edit-bar-icons-subcontainer border text-format-icons">
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/bold.svg" alt="Bold" type="image/svg+xml"></object>
        <span class="tooltip">سميك</span>
      </li>
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/italic.svg" alt="Italic" type="image/svg+xml"></object>
        <span class="tooltip">مائل</span>
      </li>
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/through.svg" alt="Strikethrough" type="image/svg+xml"></object>
        <span class="tooltip">خط متوسط</span>
      </li>
    </ul>

    <ul class="edit-bar-icons-subcontainer border lists-icons">
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/list.svg" alt="List" type="image/svg+xml"></object>
        <span class="tooltip">قائمة</span>
      </li>
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/numbered_list.svg" alt="Numbered List" type="image/svg+xml"></object>
        <span class="tooltip">قائمة مرقمة</span>
      </li>
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/check_list.svg" alt="Check List" type="image/svg+xml"></object>
    ...
    <ul class="edit-bar-icons-subcontainer border input-icons">
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/image.svg" alt="Insert Image" type="image/svg+xml"></object>
        <span class="tooltip">صورة</span>
      </li>
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/link.svg" alt="Add Link" type="image/svg+xml"></object>
    ...
    <ul class="edit-bar-icons-subcontainer border quotes-icons">
      <li class="list-element edit-bar-icon">
        <object class="svg-object" data="/assets/edit_page_icons/quotes.svg" alt="Quotes" type="image/svg+xml"></object>
